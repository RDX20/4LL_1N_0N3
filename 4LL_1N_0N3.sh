...
echo $i" |"$cy"     BANGLADESH HACKER"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" RDX PALLAB"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" RDXPALLAB007"$i"                   |"
echo $i" |"$pu" Contact WhatsApp :"$ku" +8801940666196"$i"             |"
echo $i" |"$pu" Contact Gmail :"$ku" babykgf2@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" P"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB BR1G4D3    "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB iqbalz     "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" L"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" L"$i" |"
echo $i"|"$me" 6"$i" |"$cy" BRUTEFORCE FB ( root )   "$i"|"$i"    |"$cy" A"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" B"$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" N"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU COEG  "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" S"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"RDX"$bi"]"$me"======"$bi"["$i""Choose Number""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $i"If there is an error you can ask me"
sleep 2
echo $ku"WhatsApp :"$i" +8801940666196"
echo $ku"Facebook :"$i" RdxPallab007"
sleep 2
